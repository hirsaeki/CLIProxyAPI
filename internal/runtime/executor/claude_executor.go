...
func (e *ClaudeExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	// --- Start Thinking Error Recovery Hook (fork) ---
	sessionID, bodyForUpstream := claudeThinkingPreRequest(bodyForUpstream, bodyForTranslation)
	// --- End Thinking Error Recovery Hook (fork) ---
	...
	httpClient := newProxyAwareHTTPClient(ctx, e.cfg, auth, 0)
	// --- Start Thinking Error Recovery Hook (fork) ---
	httpClient = wrapHTTPClientWithThinkingRecovery(httpClient, sessionID, bodyForUpstream, ctx)
	// --- End Thinking Error Recovery Hook (fork) ---
